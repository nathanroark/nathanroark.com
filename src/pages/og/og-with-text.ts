// // ==================================================
// // This file currently doesn't work.... not sure why
// // TODO: fix this file so that the text is shown when linking something
//
// // Filename: src/pages/og/[slug].png.ts
// // ==================================================
...
//       <text font-family="ui-sans-serif, system-ui" font-size="48" font-weight="700" fill="#fff">
//         ${albumLines.map((line, i) => `<tspan x="0" dy="${i === 0 ? 0 : 64}">${escapeXml(line)}</tspan>`).join('')}
//       </text>
//       <text y="${albumLines.length * 90}" font-family="ui-sans-serif, system-ui" font-size="42" fill="#ddd">
